  ...
  <div class="login-page">
    ...
    <div class="wrapper wrapper-full-page">
      <div class="full-page login-page section-image">
        ...
        <div class="con tent">
          <div class="container">
            <div class='col-lg-4  col-md-12 ml-auto mr-auto' style="padding: 30px">
              ...
              <form @submit.prevent="login">
                <card type="login">
                  ...
                  <fg-input v-model="form.username" addon-left-icon="nc-icon nc-single-02"
                            placeholder="Primeiro Nome..."></fg-input>
        ...
        <div class="full-page-background" style="background-image: url(static/img/background/background-2_LoginBest.jpg) "></div>
      </div>
    </div>
  </div>
</template>
